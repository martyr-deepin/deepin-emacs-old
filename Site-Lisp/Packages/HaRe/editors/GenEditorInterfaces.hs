...
cmds editFuns = [Menu "Projects"
       ...
       ,Menu "Definitions"
         ...
         {- ,editParameters editFuns "Fold Constant Definition" "subConstantDef"
            subConstantDef $ fileNamePar $ regionPar $
...
-- subConstantDef :: String -> Int -> Int -> Int -> Int -> IO ()
-- subConstantDef f l c s n= putStrLn $ ">subFunctionDef: "++f++" line: "++show l++" column: "++show c
