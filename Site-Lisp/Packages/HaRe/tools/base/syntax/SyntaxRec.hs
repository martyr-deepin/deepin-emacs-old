...
newtype HsDeclI i = Dec (BaseDeclI i)   deriving (Read, Eq, Show, Data, Typeable)
newtype HsExpI i  = Exp (BaseExpI  i)   deriving (Read, Eq, Show, Data, Typeable)
newtype HsPatI i  = Pat (BasePatI  i)   deriving (Read, Eq, Show, Data, Typeable)
newtype HsTypeI i = Typ (BaseTypeI i)   deriving (Eq, Show ,Data, Typeable)
newtype HsKind    = Knd (K HsKind)      deriving (Eq, Show, Data, Typeable)
