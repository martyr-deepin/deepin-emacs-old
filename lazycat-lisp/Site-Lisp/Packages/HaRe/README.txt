...
6.2 or with emacs 21.2.1. 

HaRe_27032008 (HaRe 0.4) is still a prototype, made available so
you can play with basic refactoring support for Haskell, and give us
feedback or bug reports (see below for changes since HaRe 0.3 and
known remaining issues). The major new feature in this 0.4 release -
apart from bug fixes - is a number of new refactorings including program slicing.
...
0 basics:
  ...
  1. ghc-6.8.2
  2. unix/gnu tools (or cygwin tools, if on windows)
  3. vim or emacs (we've tested with gvim 6.2 and with emacs 21.2.1)
  4. If you intend on running the test suite, HUnit-1.0.
...
before the line
         ...
         source /Users/..../HaRe_12022008/editors/refactor.vim   
...
--------------- how to use
  ...
  2. load the scripted interface into your favourite editor
    ...
    - emacs: 
      M-x load-file editors/Emacs/haskell-refac.el
  ...
  4. the Programatica frontend we use is project-based.  before
     ...
     ***IMPORTANT:*** Please re-create your projects by deleting the                                                                  
     hi directories once you have                                                                                                     
     updated your HaRe to a new snapshot/release. This should be done                                                                 
     before starting the refactorer. 
...
- no use of type info yet
  => some of the existing refactorings are problematic wrt 
     types, e.g., monomorphic vs polymorphic bindings
...
-- general
  ...
  + The API. An API for program analysis and tranformation. Together with Programatica and Strafunski,
    ...
    API at HaRe_12022008/refactorer/doc. 
  ...
  + For those users who are interested in the implementation of refactorings, we have written and 
    ...
    at HaRe_12022008/refactorer/RefacSwapArgs.hs, and HaRe_12022008/refactorer/RefacCase.hs.

  + We have a test suite to HaRe 0.3, and you can find it at HaRe_12022008/testing. There is a README file
