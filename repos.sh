...
case "$1" in
    ...
    "pull" )
        ...
        ;;
    "push" )
        git push git@github.com:linuxdeepin/deepin-emacs.git
        ;;
    "changelog" )
        git log --oneline
        ;;
    ...
    "revert" )
        ...
        ;;
    "add_remote" )
        git remote add $2 git@github.com:$2/deepin-emacs.git
        ;;
    "pull_remote" )
        git remote add $2 git@github.com:$2/deepin-emacs.git || git fetch $2 && git merge $2/master
        ;;
    "fetch" )
        git fetch $2
        ;;
